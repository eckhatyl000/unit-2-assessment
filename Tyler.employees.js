...
const empOne = new Employee('Cece', 'weekends');
const empTwo = new Employee('Schmidt', 'Monday - Friday');
const manager = new Manager('Winston', 'weekday mornings, weekday afternoons', [empOne, empTwo]);
...
*/
manager.addEmployee('El Luchador Ignacio');
